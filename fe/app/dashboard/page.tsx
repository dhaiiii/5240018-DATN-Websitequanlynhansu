    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { title: 'Total Employees', value: '1,234', change: '+12%', color: 'indigo' },
                    { title: 'Active Departments', value: '15', change: '0%', color: 'purple' },
                    { title: 'Attendance Rate', value: '98.5%', change: '+2.1%', color: 'green' },
                    { title: 'Pending Requests', value: '23', change: '-5%', color: 'orange' },
                ].map((stat, index) => (
                    ...
                    {[1, 2, 3].map((_, i) => (
                        <div key={i} className="flex items-center gap-4 p-3 hover:bg-gray-50 dark:hover:bg-zinc-700/30 rounded-xl transition-colors">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-medium text-gray-900 dark:text-white">John Smith applied for leave</p>
